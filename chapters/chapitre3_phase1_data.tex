...
This chapter describes how we generate training and validation trajectories using MoveIt2's Cartesian path planning capabilities designed for eventual deployment on the physical UR10 robot. We first explain the technical approach for generating straight-line trajectories, then detail the distinction between training and validation datasets.
