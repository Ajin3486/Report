...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{RL for Sim2Real Path Following --- UR10}}
\fancyhead[R]{\small\textit{RAFARANIAINA J. \& VOGELGESANG L.}}
\fancyhead[C]{}
\renewcommand{\headrulewidth}{0.4pt}
\fancyfoot[C]{\rule{0.4\textwidth}{0.4pt}\\[2pt]\thepage}
\renewcommand{\footrulewidth}{0pt}

% Page style for chapter opening pages
